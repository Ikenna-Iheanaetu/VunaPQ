                        ...
                        <div className='grid grid-cols-6 gap-8'>
                            <div className='col-span-6'>
                                <div className='flex flex-col gap-3'>
                                    ...
                                    <input type="text" name="" value="" placeholder='e.g Software Engineering' className='border-[1px] border-black outline-none h-[40px] rounded-md p-6' />
                                </div>
                            </div>
                            <div className='col-span-3'>
                                <div className='flex flex-col gap-3'>
                                    <label for="Department">Semester</label>
                                    <input type="text" name="" value="" placeholder='e.g Second' className='border-[1px] border-black outline-none h-[40px] rounded-md p-6' />
                                </div>
                            </div>
                            <div className='col-span-3'>
                                <div className='flex flex-col gap-3'>
                                    <label for="Department">Course Code</label>
                                    <input type="text" name="" value="" placeholder='e.g SEN182' className='border-[1px] border-black outline-none h-[40px] rounded-md p-6' />
                                </div>
                            </div>
                            <div className='col-span-6'>
